...
/** @typedef {{ id: string, date: string, deck: string, result: 'Win' | 'Loss', source?: 'local', mySeat?: number, myPlayer?: string, winnerSeat?: number, turn?: number, opponents?: { seat: number, name: string, player?: string }[] }} Game */
