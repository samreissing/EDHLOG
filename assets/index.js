(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=n(a);fetch(a.href,r)}})();function Qa(){if(typeof import.meta<"u")return"/EDHLOG/";const{pathname:t}=window.location,e=t.split("/").filter(Boolean),n=e[e.length-1]||"";return e.length&&!n.includes(".")?`/${e[0]}/`:"./"}const Ws="America/New_York";function ee(){return new Intl.DateTimeFormat("en-CA",{timeZone:Ws}).format(new Date)}function co(){return new Intl.DateTimeFormat("en-GB",{timeZone:Ws,hour:"2-digit",minute:"2-digit",hour12:!1}).format(new Date)}function io(){const t=new Intl.DateTimeFormat("en-GB",{timeZone:Ws,hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).format(new Date);return`${ee()}-${t.replace(/:/g,"-")}`}function tr(t){if(!t||typeof t!="string")return"";const e=t.trim().match(/^(\d{1,2}):(\d{2})(?::\d{2})?$/);if(!e)return"";const n=Number(e[1]),s=Number(e[2]);return n<0||n>23||s<0||s>59?"":`${String(n).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function zt(t){const e=T((t==null?void 0:t.date)||""),n=tr(t==null?void 0:t.time)||"00:00";return`${e}T${n}`}function K(t,e){const n=zt(t).localeCompare(zt(e));return n!==0?n:String(t.id||"").localeCompare(String(e.id||""))}function T(t){if(!t||typeof t!="string"||/^\d{4}-\d{2}-\d{2}$/.test(t))return t;const e=t.match(/^(\d{1,2})\/\?\/(\d{2})$/);if(e){const[,s,a]=e;return`20${a}-${s.padStart(2,"0")}-15`}const n=new Date(t);return Number.isNaN(n.getTime())?t:n.toISOString().slice(0,10)}function X(t){const e=T(t),[n,s,a]=e.split("-");return!n||!s||!a?t:new Date(Number(n),Number(s)-1,Number(a)).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})}function mn(t){return T(t).slice(0,4)}function z(t){return String((t==null?void 0:t.id)||"").trim()}function Fe(t){return String((t==null?void 0:t.commander)||(t==null?void 0:t.name)||"").trim()}function O(t){return String((t==null?void 0:t.commander)||(t==null?void 0:t.name)||"").trim()}function B(t){return String((t==null?void 0:t.name)||"").trim()||O(t)}function Ts(t){return O(t)}function As(t,e){const n=T(e)||String(e||"").trim(),s=[...t.history||[]].sort((a,r)=>String(a.changedAt).localeCompare(String(r.changedAt)));for(const a of s){const r=T(a.changedAt)||String(a.changedAt||"").trim();if(r&&n<r){const o=String(a.commander||"").trim();if(o)return o}}return O(t)}function zn(t,e){var a;const n=et(e,t.deck);if((a=n==null?void 0:n.history)!=null&&a.length)return As(n,t.date);const s=String(t.myCommander||"").trim();return s||(n?O(n):String(t.deck||"").trim())}function et(t,e){const n=String(e||"").trim();return n&&(t.find(s=>z(s)===n)||t.find(s=>Fe(s)===n)||t.find(s=>String(s.name||"").trim()===n))||null}function it(t){const e=new Map;for(const n of t){const s=z(n);s&&e.set(s,n);const a=Fe(n);a&&e.set(a,n);const r=String(n.name||"").trim();r&&r!==a&&e.set(r,n)}return e}function xn(t,e){const n=et(e,t);return n?Ts(n):String(t||"").trim()}function On(t,e){const n=et(e,t);return n?B(n):String(t||"").trim()}const er="edhlog-data-v1";let se=null,Rn=null;function lo(){return Rn}function oa(t){return`${T(t.date)}|${t.deck}|${t.result}`}async function nr(){return await(await fetch(`${Qa()}data/seed.json`,{cache:"no-store"})).json()}function uo(t){let e=!1;for(const n of t.decks)n.commander||(n.commander=n.name||"",n.name="",e=!0);return e}function mo(t){var a,r;let e=!1;function n(o){const c=o.decks.map(i=>i.id).filter(Boolean).map(i=>{const d=/^d-(\d+)$/.exec(i);return d?Number(d[1]):0});return`d-${(c.length?Math.max(...c):0)+1}`}for(const o of t.decks)o.id||(o.id=n(t),e=!0);const s=new Map;for(const o of t.decks){const c=o.id;if(!c)continue;s.set(c,c),s.set(Fe(o),c),s.set(O(o),c);const l=String(o.name||"").trim();l&&s.set(l,c);const i=(r=(a=t.meta)==null?void 0:a.deckSeedKeyById)==null?void 0:r[c];i&&s.set(i,c)}for(const o of t.games){const c=o.deck,l=s.get(c)||(t.decks.some(i=>i.id===c)?c:null);if(l){if(!o.myCommander){if(c!==l&&!/^d-\d+$/.test(c))o.myCommander=c;else{const i=t.decks.find(d=>d.id===l);i&&(o.myCommander=O(i))}e=!0}o.deck!==l&&(o.deck=l,e=!0)}}return e}function fo(t){let e=uo(t);const n=new Map;for(const s of t.games){const a=n.get(s.deck);(!a||s.date<a)&&n.set(s.deck,s.date)}for(const s of t.decks)s.createdAt||(s.createdAt=n.get(s.id)||n.get(s.commander)||n.get(s.name)||"2024-04-15",e=!0);return mo(t)&&(e=!0),po(t)&&(e=!0),e}function po(t){var n;let e=!1;for(const s of t.games){const a=et(t.decks,s.deck);if(!((n=a==null?void 0:a.history)!=null&&n.length))continue;const r=As(a,s.date);r&&s.myCommander!==r&&(s.myCommander=r,e=!0)}return e}function Ie(t){return String(t.commander||t.name||"").trim()}function sr(t,e,n){!e||!n||(t.meta||(t.meta={}),t.meta.deckSeedKeyById||(t.meta.deckSeedKeyById={}),t.meta.deckSeedKeyById[e]=n)}function ar(t,e,n){sr(t,e,n)}function rr(t,e){const n=Ie(e);n&&(t.meta||(t.meta={}),t.meta.removedSeedDeckKeys||(t.meta.removedSeedDeckKeys=[]),t.meta.removedSeedDeckKeys.includes(n)||t.meta.removedSeedDeckKeys.push(n))}function go(t){var s;const e=new Set(((s=t.meta)==null?void 0:s.removedSeedDeckKeys)||[]);if(!e.size)return!1;const n=t.decks.length;return t.decks=t.decks.filter(a=>!e.has(Ie(a))),t.decks.length!==n}function yo(t){let e=!1;const n=new Set;for(const s of t.decks)for(const a of s.history||[]){const r=String(a.commander||"").trim();if(r)for(const o of t.decks)o===s||n.has(o)||Ie(o)===r&&(n.add(o),rr(t,o),s.id&&ar(t,s.id,r),e=!0)}return n.size?(t.decks=t.decks.filter(s=>!n.has(s)),!0):e}function ho(t,e,n){var s;return{...e,id:n.id,name:n.name??e.name??"",commander:n.commander||e.commander||e.name||"",bracket:n.bracket??e.bracket??4,colors:[...(s=n.colors)!=null&&s.length?n.colors:e.colors||[]],retired:n.retired??e.retired??!1,createdAt:n.createdAt??e.createdAt,history:n.history??e.history,listUrl:n.listUrl??e.listUrl,listSource:n.listSource??e.listSource,listSyncedAt:n.listSyncedAt??e.listSyncedAt,cards:n.cards??e.cards,archetypes:n.archetypes??e.archetypes}}function or(t){let e=!1;for(const n of t.games){const s=T(n.date);s!==n.date&&(n.date=s,e=!0)}return go(t)&&(e=!0),yo(t)&&(e=!0),fo(t)&&(e=!0),e}function bo(t,e){var f,p,g,m,v;const n=new Set(e.games.map(k=>k.id)),s=t.games.length,a=new Map;for(const k of t.games)k.source==="local"&&n.has(k.id)&&a.set(k.id,k);const r=t.games.filter(k=>k.source==="local"&&!n.has(k.id));t.games=e.games.map(k=>{const R=a.get(k.id);return R?{...k,...R,source:"local"}:{...k}});let o=t.games.length+1;for(const k of r)t.games.push({...k,id:`game-${o++}`,source:"local"});const c=new Map,l=new Map;for(const k of t.decks){const R=Ie(k);R&&c.set(R,k);const h=k.id,$=h&&((p=(f=t.meta)==null?void 0:f.deckSeedKeyById)==null?void 0:p[h]);$&&l.set($,k)}const i=new Set(((g=t.meta)==null?void 0:g.removedSeedDeckKeys)||[]),d=new Set,u=[];for(const k of e.decks){const R=Ie(k);if(!R||i.has(R))continue;const h=c.get(R)||l.get(R);h!=null&&h.id&&d.add(h.id);const $=h?ho(t,k,h):{...k,colors:[...k.colors||[]]};h!=null&&h.id&&ar(t,h.id,R),u.push($)}for(const k of t.decks){if(k.id&&d.has(k.id))continue;const R=Ie(k);R&&i.has(R)||u.push({...k,colors:[...k.colors||[]]})}return t.decks=u,t.meta={...t.meta,seedHash:(m=e.meta)==null?void 0:m.seedHash,seedGames:((v=e.meta)==null?void 0:v.seedGames)??e.games.length},{games:e.games.length,keptLocal:r.length,removed:Math.max(0,s-t.games.length)}}function Bs(){if(se)return se;const t=localStorage.getItem(er);return t?(se=JSON.parse(t),or(se)&&ct(se),se):null}async function $o(){var s,a;Rn=null;const t=await nr();let e=Bs();if(!e)return ct(t),t;const n=(s=t.meta)==null?void 0:s.seedHash;if(n){const r=e.games.length,o=(a=e.meta)==null?void 0:a.seedHash,c=JSON.stringify(e.decks),l=bo(e,t),i=or(e),d=JSON.stringify(e.decks)!==c;(r!==e.games.length||o!==n||d||i)&&(ct(e),(l.removed>0||o!==n)&&(Rn=l))}return e}function ct(t){try{return se=t,localStorage.setItem(er,JSON.stringify(t)),!0}catch(e){return console.error("EDHLOG save failed",e),!1}}async function ko(){const t=await nr();return ct(t),Rn=null,t}function cr(t,e){const n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(n),a=document.createElement("a");a.href=s,a.download=e,a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.click(),a.remove(),window.setTimeout(()=>URL.revokeObjectURL(s),1e3)}function vo(){const t=Bs();t&&cr(t,`edhlog-${ee()}.json`)}function So(t){const e=t||Bs();e&&cr(e,`edhlog-${io()}.json`)}async function wo(t){const e=await t.text(),n=JSON.parse(e);if(!n.decks||!n.games)throw new Error("Invalid EDHLOG data file");return ct(n),n}function Co(t){const e=t.map(s=>parseInt(s.id.replace("game-",""),10)).filter(s=>!Number.isNaN(s));return`game-${(e.length?Math.max(...e):0)+1}`}function ls(t){const e=t.decks.map(s=>s.id).filter(Boolean).map(s=>{const a=/^d-(\d+)$/.exec(s);return a?Number(a[1]):0});return`d-${(e.length?Math.max(...e):0)+1}`}const ds=[[],["W"],["U"],["B"],["R"],["G"],["W","U"],["R","W"],["U","B"],["B","G"],["R","G"],["U","R"],["W","B"],["B","R"],["W","G"],["U","G"],["W","B","G"],["W","U","G"],["W","U","B"],["U","B","R"],["W","U","R"],["B","R","G"],["W","B","R"],["W","R","G"],["U","B","G"],["U","R","G"],["U","B","R","G"],["W","B","R","G"],["W","U","R","G"],["W","B","U","G"],["W","B","U","R"],["W","U","B","R","G"]];function ir(t){return[...t].sort((e,n)=>tn.indexOf(e)-tn.indexOf(n))}function lr(t){return new Set((t||[]).filter(e=>tn.includes(e)))}function dr(t,e){return t.length?t.length===e.size&&t.every(n=>e.has(n)):e.size===0}function Ns(t){const e=lr(t);if(!e.size)return[];for(const n of ds)if(n.length&&dr(n,e))return[...n];return ir(e)}function us(t){const e=lr(t);for(let s=0;s<ds.length;s++)if(dr(ds[s],e))return s;const n=ir(e).join("");return 1e4+e.size*1e3+n.split("").reduce((s,a)=>s*10+tn.indexOf(a),0)}const tn=["W","U","B","R","G","C"],Fn={W:"White",U:"Blue",B:"Black",R:"Red",G:"Green",C:"Colorless"},xo=5,Ro=20;function Mn(t){const e=tn.indexOf(t);return e===-1?99:e}function W(t,e){return e?t/e:0}function pe(t,e=2){const n=(t*100).toFixed(e);return`${e>0?n.replace(/\.?0+$/,""):n}%`}function ft(t,e){return(t+xo)/(e+Ro)}function In(t,e){const n=new Map;for(const s of t){const a=z(s);n.set(a,{...s,id:a,games:0,wins:0,losses:0,lastPlayed:null})}for(const s of e){const a=s.deck;if(!n.has(a)){const o=et(t,a);n.set(a,{id:(o==null?void 0:o.id)||a,name:(o==null?void 0:o.name)||"",commander:(o==null?void 0:o.commander)||s.myCommander||a,bracket:(o==null?void 0:o.bracket)??4,colors:(o==null?void 0:o.colors)??[],retired:(o==null?void 0:o.retired)??!1,createdAt:(o==null?void 0:o.createdAt)||s.date,games:0,wins:0,losses:0,lastPlayed:null})}const r=n.get(a);r.games+=1,s.result==="Win"?r.wins+=1:r.losses+=1,(!r.lastPlayed||s.date>r.lastPlayed)&&(r.lastPlayed=s.date)}return[...n.values()].map(s=>({...s,winRate:W(s.wins,s.games),normalizedWr:ft(s.wins,s.games)}))}function ur(t){const e=t.filter(s=>s.result==="Win").length,n=t.length;return{games:n,wins:e,losses:n-e,winRate:W(e,n),...Ds(t)}}function Ds(t){const e=t.filter(a=>a.result==="Win"&&Number(a.turn)>0).map(a=>Number(a.turn)),n=t.filter(a=>a.result==="Loss"&&Number(a.turn)>0).map(a=>Number(a.turn)),s=a=>a.length?a.reduce((r,o)=>r+o,0)/a.length:null;return{avgTurnWin:s(e),avgTurnLoss:s(n)}}function Mo(t,e,n="",s=null){const a=it(e),r=s!=null&&s.length?new Set(s.map(String)):n?new Set([String(n)]):null,o=t.filter(f=>{if(!r)return!0;const p=a.get(f.deck),g=String(f.bracket??(p==null?void 0:p.bracket)??4);return r.has(g)}),c=ur(o),l=In(e,o).filter(f=>f.games>0),i=Ps(l,"normWr","desc").slice(0,3),{avgTurnWin:d,avgTurnLoss:u}=Ds(o);return{overview:c,podium:i,avgTurnWin:d,avgTurnLoss:u}}function mt(t,e){const n=e.get(t.deck);return t.bracket??(n==null?void 0:n.bracket)??4}const Jn=["","1","2","3","4","5"];function Io(t=""){return t?`Bracket ${t}`:"All Brackets"}function ca(t=""){const n=(Jn.indexOf(String(t||""))+1)%Jn.length;return Jn[n]}function jn(t,e,n=""){if(!n)return t;const s=it(e);return t.filter(a=>String(mt(a,s))===String(n))}function Lo(t,e){const n=new Map(e.map(a=>[a.id||Fe(a),a])),s=[1,2,3,4,5].map(a=>({bracket:a,games:0,wins:0}));for(const a of t){const r=mt(a,n),o=s.find(c=>c.bracket===r)??s[3];o.games+=1,a.result==="Win"&&(o.wins+=1)}return s.map(a=>({...a,winRate:W(a.wins,a.games),normalizedWr:ft(a.wins,a.games)}))}function Eo(t){const e=new Map;for(const n of t){const s=mn(n.date);e.has(s)||e.set(s,{year:s,games:0,wins:0});const a=e.get(s);a.games+=1,n.result==="Win"&&(a.wins+=1)}return[...e.values()].sort((n,s)=>n.year.localeCompare(s.year)).map(n=>({...n,winRate:W(n.wins,n.games),normalizedWr:ft(n.wins,n.games)}))}function Wo(t){const e=[...t].sort(K),n=e.length,s=[];for(let o=100;o<=n;o+=100){const c=o-99,i=e.slice(c-1,o).filter(d=>d.result==="Win").length;s.push({label:`${c}-${o}`,rangeStart:c,rangeEnd:o,games:100,wins:i,winRate:W(i,100)})}const a=n%100;if(a>0){const o=n-a+1,l=e.slice(o-1,n).filter(i=>i.result==="Win").length;s.push({label:`${o}-${n}`,rangeStart:o,rangeEnd:n,games:a,wins:l,winRate:W(l,a)})}const r=[];for(let o=100;o<=n;o+=100){const l=e.slice(0,o).filter(i=>i.result==="Win").length;r.push({label:`1-${o}`,games:o,wins:l,winRate:W(l,o)})}if(a>0){const c=e.slice(0,n).filter(l=>l.result==="Win").length;r.push({label:`1-${n}`,games:n,wins:c,winRate:W(c,n)})}return{windows:s,cumulative:r}}function To(){return`${Qa()}mana`}function Kt(t){const e=Ns(t),n=To();return e.length?e.map(s=>`<img class="mana-img" src="${n}/${s}.svg" alt="${s}" title="${Fn[s]||s}" />`).join(""):`<img class="mana-img" src="${n}/C.svg" alt="C" title="Colorless" />`}function Ps(t,e,n){const s=n==="asc"?1:-1;function a(r,o,c){const l=!r.games,i=!o.games;return l&&i?B(r).localeCompare(B(o)):l?1:i?-1:c()||B(r).localeCompare(B(o))}return[...t].sort((r,o)=>{if(e==="name")return s*B(r).localeCompare(B(o));if(e==="games")return a(r,o,()=>s*(r.games-o.games));if(e==="wr"||e==="winRate")return a(r,o,()=>s*(r.winRate-o.winRate));if(e==="normWr")return a(r,o,()=>s*(r.normalizedWr-o.normalizedWr));if(e==="bracket")return s*(r.bracket-o.bracket)||B(r).localeCompare(B(o));if(e==="wins")return a(r,o,()=>s*(r.wins-o.wins)||s*(r.winRate-o.winRate));if(e==="losses")return s*(r.losses-o.losses)||B(r).localeCompare(B(o));if(e==="newest"||e==="createdAt"){const c=r.createdAt||"",l=o.createdAt||"";return s*c.localeCompare(l)||B(r).localeCompare(B(o))}if(e==="recent"||e==="lastPlayed"){const c=r.lastPlayed||"",l=o.lastPlayed||"";return s*c.localeCompare(l)||B(r).localeCompare(B(o))}return e==="colors"||e==="colorIdentity"?s*(us(r.colors)-us(o.colors))||B(r).localeCompare(B(o)):0})}const Xn=.25;function Gs(t,e,n){return Math.min(n,Math.max(e,t))}function mr(t,e,n){return`hsl(${t} ${e}% ${n}%)`}function Zn(t,e,n){return t+(e-t)*n}function Ao(t,e,n){return mr(Zn(t[0],e[0],n),Zn(t[1],e[1],n),Zn(t[2],e[2],n))}function we(t,e){for(let n=0;n<t.length-1;n++){const s=t[n],a=t[n+1];if(e<=a.at){const r=a.at-s.at||1,o=(e-s.at)/r;return Ao(s.hsl,a.hsl,Gs(o,0,1))}}return mr(...t[t.length-1].hsl)}function Bo(t){const e=Gs(t,0,1);return e>=Xn?we([{at:Xn,hsl:[128,48,84]},{at:.35,hsl:[132,52,68]},{at:.45,hsl:[136,58,48]},{at:.6,hsl:[140,62,34]},{at:.8,hsl:[144,68,22]},{at:1,hsl:[148,72,12]}],e):we([{at:0,hsl:[0,72,48]},{at:.1,hsl:[18,78,52]},{at:.18,hsl:[42,90,58]},{at:Xn,hsl:[128,48,84]}],e)}function No(t,e){if(!e||e<=0)return"transparent";const n=t/e;return n>=1?n<=1.1?we([{at:1,hsl:[140,62,34]},{at:1.1,hsl:[128,48,84]}],n):we([{at:1.1,hsl:[55,90,58]},{at:1.35,hsl:[18,78,52]},{at:1.7,hsl:[0,72,42]},{at:2.5,hsl:[0,75,28]}],n):n>=.9?we([{at:.9,hsl:[185,55,48]},{at:1,hsl:[140,62,34]}],n):we([{at:0,hsl:[275,58,20]},{at:.5,hsl:[245,52,32]},{at:.9,hsl:[185,55,48]}],n)}function Do(t){return Gs(t,0,1)>=.5?"#f4fff8":"#0D0F0F"}function Po(t,e){if(!e||e<=0)return"inherit";const n=t/e;return n>=.92&&n<=1.08||n>=1.35||n<=.55?"#f4fff8":"#0D0F0F"}function N(t,e=2){if(t==null||Number.isNaN(t))return'<span class="wr-cell wr-na">—</span>';const n=Bo(t),s=Do(t);return`<span class="wr-cell" style="background:${n};color:${s}">${pe(t,e)}</span>`}function Lt(t,e,n=String(t)){if(t==null||Number.isNaN(t))return'<span class="wr-cell wr-na">—</span>';if(!e||e<=0)return`<span class="wr-cell">${n}</span>`;const s=No(t,e),a=Po(t,e);return`<span class="wr-cell" style="background:${s};color:${a}">${n}</span>`}function Et(t,e){const n=t.filter(s=>s.key==="C"?!1:e==="decks"?(s.decks||0)>0:(s.games||0)>0);return n.length?n.reduce((s,a)=>s+(a[e]||0),0)/n.length:0}function Go(t,e){return!t||t.col!==e?"":t.dir==="asc"?" ↑":" ↓"}function w(t,e,n,s,a=""){return`<th class="sortable${(s==null?void 0:s.col)===e?" sorted":""} ${a}" data-sort-table="${t}" data-sort-col="${e}">${n}${Go(s,e)}</th>`}function Sn(t,e){return(t==null?void 0:t.col)===e?{col:e,dir:t.dir==="asc"?"desc":"asc"}:{col:e,dir:"desc"}}const wt={wins:"winRate"};function zo(t){return t?Array.isArray(t)?t:[t]:[]}function st(t,e,n,s={}){if(!(e!=null&&e.col)||!n[e.col])return t;const a=n[e.col],r=zo(s[e.col]);return[...t].sort((o,c)=>{const l=ia(a(o),a(c),e.dir);if(l!==0)return l;for(const i of r){const d=typeof i=="string"?i:i.key,u=typeof i=="string"?e.dir:i.dir??e.dir;if(!n[d])continue;const f=ia(n[d](o),n[d](c),u);if(f!==0)return f}return 0})}function ia(t,e,n){const s=n==="asc"?1:-1;return t==null&&e==null?0:t==null?1:e==null?-1:typeof t=="string"&&typeof e=="string"?s*t.localeCompare(e):s*(t-e)}const xt={W:"#fffbd5",U:"#aae0fa",B:"#2a2a35",R:"#f9aa8f",G:"#9bd3ae",C:"#ccc2c0"};function Oo(t){return[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)]}function Fo(t,e,n){const s=a=>Math.max(0,Math.min(255,Math.round(a)));return`#${[t,e,n].map(a=>s(a).toString(16).padStart(2,"0")).join("")}`}function fr(t){const e=t.filter(o=>xt[o]);if(!e.length)return xt.C;if(e.length===1)return xt[e[0]];let n=0,s=0,a=0;for(const o of e){const[c,l,i]=Oo(xt[o]);n+=c,s+=l,a+=i}const r=e.length;return Fo(n/r,s/r,a/r)}const Ln=["#5b9fd4","#3dba7a","#c9a227","#e05c5c","#9b7ad4","#e08a4a","#6ec6ca","#d46a9b","#7a8cff","#b8e986"];function zs(t){return Ln[(t-1)%Ln.length]}function ms(t,e){if(t.bracket!=null)return zs(t.bracket);const n=(t.colors||(t.color?[t.color]:[])).filter(s=>xt[s]);return n.length>1?fr(n):n.length===1?xt[n[0]]:t.color&&xt[t.color]?xt[t.color]:Ln[e%Ln.length]}function la(t){return{colors:t.displayColors,color:t.key!=="C"&&t.displayColors.length===1?t.displayColors[0]:void 0,key:t.key}}function yn(t,e,n,s){const a=(s-90)*Math.PI/180;return{x:t+n*Math.cos(a),y:e+n*Math.sin(a)}}function jo(t,e,n,s,a,r){const o=r-a;if(o<=0)return"";o>=360&&(r=a+359.999);const c=yn(t,e,n,a),l=yn(t,e,n,r),i=yn(t,e,s,r),d=yn(t,e,s,a),u=r-a>180?1:0;return`M ${c.x} ${c.y} A ${n} ${n} 0 ${u} 1 ${l.x} ${l.y} L ${i.x} ${i.y} A ${s} ${s} 0 ${u} 0 ${d.x} ${d.y} Z`}function Ho(t){return String(t).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function qo(t){return t.bracket!=null?`Bracket ${t.bracket}`:t.key?t.key:"Slice"}function _o(t,e){if(t.bracket!=null)return{fill:zs(t.bracket),def:null};const n=(t.colors||(t.color?[t.color]:[])).filter(s=>xt[s]);return n.length<=1?{fill:n[0]?xt[n[0]]:ms(t,e),def:null}:{fill:fr(n),def:null}}function da(t,e=0,{animate:n=!0}={}){const s=t.filter(d=>d.value>0),a=s.reduce((d,u)=>d+u.value,0),r=n?"pie-panel":"pie-panel pie-panel--static";if(!a)return`<div class="${r} pie-panel--empty" data-pie-key="${e}"></div>`;let o=0;const c=[],l=n?"pie-slice":"pie-slice pie-slice--static",i=s.map((d,u)=>{const f=d.value/a*360,p=jo(50,50,44,28,o,o+f),{fill:g,def:m}=_o(d,u);m&&c.push(m);const v=d.hover||String(d.value);o+=f;const k=n?` style="animation-delay:${u*.045}s"`:"";return`<path class="${l}" d="${p}" fill="${g}" data-hover="${Ho(v)}"${k} />`});return`
    ...
    <div class="trends-chart-wrap">
      ...
      <svg class="trends-chart" viewBox="0 0 ${Ft} ${$t}" role="img" aria-label="Win rate over time">
        ${o}
        ${s}
        <text class="trends-axis-label" x="${L.left+t/2}" y="${$t-28}" text-anchor="middle">Date</text>
      </svg>
      <div class="trends-chart-tip" hidden></div>
    </div>`}function Pc(t){return[0,.25,.5,.75,1].map(n=>{const s=L.top+t-n*t;return`<line class="trends-grid-line" x1="${L.left}" y1="${s}" x2="${Ft-L.right}" y2="${s}" />
        <text class="trends-axis-label" x="${L.left-8}" y="${s+4}" text-anchor="end">${Math.round(n*100)}%</text>`}).join("")}function Gc(t,e){const n=T(t),s=T(e);if(!n||!s||n===s)return n||s;const a=new Date(`${n}T00:00:00`).getTime(),r=new Date(`${s}T00:00:00`).getTime();return new Date(Math.round((a+r)/2)).toISOString().slice(0,10)}function Nn(t){const e=Ft-L.left-L.right,n=L.left,s=L.left+e,a=L.left+e/2,r=T(t.start),o=T(t.end);if(!r||!o)return"";if(r===o)return`<text class="trends-axis-label trends-x-label" x="${a}" y="${$t-10}" text-anchor="middle">${tt(X(r))}</text>`;const c=Gc(r,o);return`
    ...
    <text class="trends-axis-label trends-x-label" x="${s}" y="${$t-10}" text-anchor="end">${tt(X(o))}</text>`}function zc(t,e,{startDate:n,endDate:s}={}){return n&&s?Nn({start:n,end:s}):t.length?(t.length<=3?t.map((r,o)=>o):[0,Math.floor((t.length-1)/2),t.length-1]).map(r=>{const o=t[r],c=X(e[r].date),l=r===0,i=r===t.length-1,d=l?"start":i?"end":"middle";let u=o.x;return l&&(u=Math.max(o.x,L.left)),i&&(u=Math.min(o.x,Ft-L.right)),`<text class="trends-axis-label trends-x-label" x="${u}" y="${$t-10}" text-anchor="${d}">${tt(c)}</text>`}).join(""):""}function Oc(t,e=null){const n=Ft-L.left-L.right,s=$t-L.top-L.bottom;return t.map((a,r)=>{const o=L.left+(t.length===1?n/2:r/(t.length-1)*n),c=L.top+s-a.winRate*s;return{...a,x:o,y:c}})}function Wr(t,e,n){const s=Ft-L.left-L.right,a=$t-L.top-L.bottom;return t.map(r=>{const o=Dc(r.date,e,n,s),c=L.top+a-r.winRate*a;return{...r,x:o,y:c}})}function Tr(t,{seriesId:e="",color:n=null,label:s=""}={}){const a=[...t].sort((o,c)=>o.x-c.x);return{linePath:a.map((o,c)=>`${c===0?"M":"L"} ${o.x} ${o.y}`).join(" "),color:n,dots:a.map(o=>`
    ...
    `).join("")}}function Ar(t){const e=L.top+t-.25*t;return{baselineY:e,markup:`
      ${Pc(t)}
      <line class="trends-baseline" x1="${L.left}" y1="${e}" x2="${Ft-L.right}" y2="${e}" />`}}function Us(t,e,n,s){const a=Math.round(Number(n))||1,r=Math.round(Number(s))||a,o=Math.min(a,r),c=Math.max(a,r);let l=Math.round(Number(t))||o,i=Math.round(Number(e))||c;return l=Math.max(o,Math.min(l,c)),i=Math.max(o,Math.min(i,c)),l>i&&(l=i),i<l&&(i=l),{min:l,max:i}}function Vs(t="trends"){return{minInput:`${t}-game-min-input`,maxInput:`${t}-game-max-input`,minSlider:`${t}-game-min-slider`,maxSlider:`${t}-game-max-slider`,fill:`${t}-game-range-fill`}}function Br(t){const{min:e,max:n,boundsMin:s,boundsMax:a,idPrefix:r="trends"}=t,o=Vs(r),c=a-s;if(c<=0)return"";const l=(e-s)/c*100,i=(n-s)/c*100;return`
    ...
    ${l}`}function fi(t,e,n="games",s,a){const o=[{id:"games",label:"Games"},{id:"decks",label:"Deck Matchups"},{id:"players",label:"Player Matchups"}].map(f=>`<button type="button" role="tab" aria-selected="${f.id===n}" class="sub-tab ${f.id===n?"active":""}" data-entity-report-tab="${f.id}">${f.label}</button>`).join(""),c=mi(t,e,a),l=(s==null?void 0:s.players)??{col:"normalizedMatchupImpact",dir:"desc"},i=(s==null?void 0:s.decks)??{col:"normalizedMatchupImpact",dir:"desc"},d=Ia(t.playerMatchups,f=>Ma(f,"player",e,t.playerScope),"entity-matchups-players",l),u=Ia(t.deckMatchups,f=>Ma(f,"deck",e,t.playerScope),"entity-matchups-decks",i);return`
        ...
        <div class="entity-deck-card">
          ...
          <div class="entity-deck-card-body">
            ...
            <div class="entity-deck-card-stats">
              ...
              <span>${s.games?N(s.winRate??W(s.wins??0,s.games)):"—"}</span>
            </div>
          </div>
        </div>`}).join("")}
    ...
    <div class="modal-content modal-content-wide modal-content-report entity-report-player" data-entity-report-root="${Q(l)}">
      ...
      ${u}
      ${f}
    </div>`}const Si={opponent:t=>t.opponent,games:t=>t.games,wins:t=>t.wins,winRate:t=>t.winRate,matchupImpact:t=>t.matchupImpact,normalizedMatchupImpact:t=>t.normalizedMatchupImpact};function Ia(t,e,n,s){if(!t.length)return'<p class="muted-text entity-report-empty">No matchup data yet.</p>';const a=st(t,s,Si,wt);return`
    ...
    <div id="recovery-modal" class="modal">
      ...
      <g class="turn-wr-point" data-turn="${g.turn}" data-wr="${g.winRate}" data-games="${g.games}" data-wins="${g.wins}" data-losses="${g.losses}" data-ended="${m}" data-mode="${s}">
        <circle class="turn-wr-point-hit" cx="${v}" cy="${k}" r="10" />
        <circle class="turn-wr-point-dot" cx="${v}" cy="${k}" r="3.5" />
      </g>`}).join("");return`
      ...
      <div class="turn-wr-chart-tip" hidden></div>
          ...
          <div class="turn-stat-box${e.games?"":" turn-stat-box-empty"}">
            ...
            <div class="turn-stat-wr">
              <div><span class="turn-stat-metric-label">WR</span><strong>${n?N(e.winRate):"—"}</strong></div>
              <div><span class="turn-stat-metric-label">Norm WR</span><strong>${n?N(e.normalizedWr):"—"}</strong></div>
            </div>
          ...
          <div class="turn-stat-box${e.games?"":" turn-stat-box-empty"}">
            ...
            <div class="turn-stat-wr">
              <div><span class="turn-stat-metric-label">WR</span><strong>${e.games?N(e.winRate):"—"}</strong></div>
              <div><span class="turn-stat-metric-label">Norm WR</span><strong>${e.games?N(e.normalizedWr):"—"}</strong></div>
            </div>
    ...
    </div>`}function kn(t,e,n,s={}){return Xr(t,e,n,s)}function Ue(){return`<button type="button" class="btn btn-ghost btn-sm stats-deck-filter-toggle" id="stats-deck-filter-toggle">${_l(dt)}</button>`}function Se(t,e){return`<button type="button" class="btn btn-ghost btn-sm bracket-filter-btn ${!!e?"active":""}" id="${t}">${Io(e)}</button>`}function cs(t){return t?` style="--series-color:${t}"`:""}function ke(t,e){return`
    <div class="chart-section">
      <div class="chart-clear-row">
        <button type="button" class="btn btn-ghost btn-sm" id="${e}">Clear Selection</button>
      </div>
      ${t}
    </div>`}async function Gn(){await Promise.all([kc(ba(y.games)),Rc([...Ic(y.games),...ba(y.games),...Cc(y.decks)])]),xc(y.decks)&&ct(y),!ne&&x()}function Wl(){const t=document.querySelector(".footer-actions");if(!t||document.getElementById("recover-btn"))return;const e=document.getElementById("reset-btn"),n=document.createElement("button");n.type="button",n.className="btn btn-ghost",n.id="recover-btn",n.textContent="Recover data",e?t.insertBefore(n,e):t.appendChild(n)}async function Tl(){sessionStorage.removeItem("edhlog-stale-reload"),y=await $o();const t=lo();Wl(),Al(),Zr(),x(),setTimeout(()=>{Gn()},0),Ai({deck:()=>{ye(),x()},game:()=>{Z=null,Nt=!1,x()},gameDetail:()=>{Zt=null,x()},entityReport:()=>{F=null,It()},recovery:Ae}),t&&(t.removed>0?P(`Removed ${t.removed} duplicate games — now at ${t.games+t.keptLocal} total`):t.keptLocal>0?P(`Synced ${t.games} games from spreadsheet (${t.keptLocal} local-only kept)`):P(`Synced ${t.games} games from spreadsheet`))}function Al(){var t;Ti(),document.addEventListener("click",e=>{const n=e.target.closest("[data-entity-report]");if(n){Cl(n.dataset.entityReport,n.dataset.entityKey,n.dataset.entityPlayerScope||null,n.dataset.entityDeckSlot||null);return}const s=e.target.closest("[data-entity-report-tab]");if(s&&F){Ml(s.dataset.entityReportTab);return}const a=e.target.closest("[data-entity-hero-tab]");if(a&&F){xl(a.dataset.entityHeroTab);return}}),document.getElementById("nav").addEventListener("click",e=>{const n=e.target.closest("[data-view]");if(!n)return;const s=Y;Y=n.dataset.view,s==="stats"&&Y!=="stats"&&ja(),s==="decks"&&Y!=="decks"&&Ha(),s==="games"&&Y!=="games"&&qa(),Y==="stats"&&(E="overview",ja()),Y==="decks"&&Ha(),Y==="games"&&qa(),Y!=="decks"&&ye(),_a(),Zr(),x()}),document.getElementById("main").addEventListener("input",e=>{var n,s,a,r,o,c,l,i,d,u;e.target.id==="matchup-search"?(Dn=e.target.value,x()):e.target.id==="totals-search"?(Pn=e.target.value,x()):e.target.id==="seats-range-start"||e.target.id==="seats-range-end"?(Xt.customized=!0,Xt.start=((n=document.getElementById("seats-range-start"))==null?void 0:n.value)||null,Xt.end=((s=document.getElementById("seats-range-end"))==null?void 0:s.value)||null,x()):e.target.id==="colors-range-start"||e.target.id==="colors-range-end"?(Ze.customized=!0,Ze.start=((a=document.getElementById("colors-range-start"))==null?void 0:a.value)||null,Ze.end=((r=document.getElementById("colors-range-end"))==null?void 0:r.value)||null,x()):e.target.id==="brackets-range-start"||e.target.id==="brackets-range-end"?(Qe.customized=!0,Qe.start=((o=document.getElementById("brackets-range-start"))==null?void 0:o.value)||null,Qe.end=((c=document.getElementById("brackets-range-end"))==null?void 0:c.value)||null,x()):e.target.id==="trends-range-start"||e.target.id==="trends-range-end"?(Gt.customized=!0,Gt.start=((l=document.getElementById("trends-range-start"))==null?void 0:l.value)||null,Gt.end=((i=document.getElementById("trends-range-end"))==null?void 0:i.value)||null,Ht(),x()):(e.target.id==="entity-report-range-start"||e.target.id==="entity-report-range-end")&&(We.customized=!0,We.start=((d=document.getElementById("entity-report-range-start"))==null?void 0:d.value)||null,We.end=((u=document.getElementById("entity-report-range-end"))==null?void 0:u.value)||null,Rl(),It())}),document.getElementById("main").addEventListener("click",e=>{var b,M;const n=e.target.closest("[data-sort-table]");if(n){const C=n.getAttribute("data-sort-table"),I=n.getAttribute("data-sort-col");S[C]=Sn(S[C],I),C==="decks-main"&&(V=I,Te=S[C].dir,I==="lastPlayed"?V="recent":I==="createdAt"&&(V="newest")),x();return}if(e.target.id==="stats-deck-filter-toggle"){dt=dt==="all"?"active":dt==="active"?"retired":"all",E==="colors"&&(yt=new Set),E==="brackets"&&(Ct=ht()),E==="trends"&&Ht(),x();return}if(e.target.id==="matchup-combine-decks"){Ut=e.target.checked,x();return}if(e.target.id==="matchup-split-partners"){rn=e.target.checked,x();return}if(e.target.id==="matchup-split-players"){Jt=e.target.checked,x();return}if(e.target.id==="totals-split-partners"){gn=e.target.checked,x();return}if(e.target.id==="totals-exclude-me"){de=e.target.checked,x();return}if(e.target.id==="totals-color-view-toggle"){on=ts(on),x();return}if(e.target.id==="totals-color-agg-toggle"){cn=cn==="inclusive"?"exclusive":"inclusive",x();return}if(e.target.id==="matchup-color-view-toggle"){sn=ts(sn),x();return}if(e.target.id==="matchup-color-agg-toggle"){an=an==="inclusive"?"exclusive":"inclusive",x();return}if(e.target.id==="color-order-toggle"){un=un==="wubrgc"?"cgrbuw":"wubrgc",S["color-stats"]={col:"colorOrder",dir:"asc"},x();return}if(e.target.id==="color-view-toggle"){Ge=ts(Ge),yt=new Set,x();return}if(e.target.id==="color-agg-toggle"){ze=ze==="inclusive"?"exclusive":"inclusive",yt=new Set,x();return}if(e.target.id==="archetype-view-toggle"){me=Zi(me),x();return}if(e.target.id==="overview-bracket-filter-toggle"||e.target.id==="stats-bracket-filter-toggle"){J=ca(J),E==="brackets"&&(Ct=ht(),le=J?"filter":null),E==="colors"&&(yt=new Set),E==="trends"&&Ht(),x();return}if(e.target.id==="totals-bracket-filter-toggle"){Pe=ca(Pe),x();return}const s=e.target.closest("[data-trends-cumulative]");if(s){rt=ht(),ae=new Map,qe(),Ht(),G={kind:"cumulative",rangeEnd:Number(s.dataset.rangeEnd)},x();return}const a=e.target.closest("[data-trends-year]");if(a){rt=ht(),ae=new Map,qe(),Ht(),G={kind:"year",year:a.dataset.trendsYear},x();return}if(e.target.closest("[data-trends-all]")){rt=ht(),ae=new Map,qe(),Ht(),G={kind:"all"},x();return}const o=e.target.closest("[data-matchup-tab]");if(o){const C=o.getAttribute("data-matchup-tab");C!==Yt&&Ke("matchups"),Yt=C,x();return}const c=e.target.closest("[data-totals-tab]");if(c){const C=c.getAttribute("data-totals-tab");C!==U&&Ke("totals"),U=C,x();return}const l=e.target.closest("[data-stats-tab]");if(l){const C=l.getAttribute("data-stats-tab");C!==E&&(Ke(E),Ke(C),_a()),E=C,x();return}if(e.target.id==="clear-colors-chart"){yt=new Set,x();return}if(e.target.id==="clear-brackets-chart"){Ct=ht(),le=null,x();return}if(e.target.id==="clear-trends-chart"){rt=ht(),ae=new Map,qe(),Ht(),x();return}if(e.target.id==="clear-seats-chart"){Wt=[],x();return}if(e.target.id==="clear-totals-seats-chart"){Tt=[],x();return}const i=e.target.closest("[data-color-chart-row]");if(i&&E==="colors"){const C=i.dataset.colorChartRow;yt.has(C)?yt.delete(C):yt.add(C),x();return}const d=e.target.closest("[data-bracket-chart-row]");if(d&&E==="brackets"){const C=Number(d.dataset.bracketChartRow),I=String(C),_=Oe().bracketStats.filter(A=>A.games>0).length;J="",le="table",Pa(Ct,I,_),Ct.size||(le=null),x();return}const u=e.target.closest("[data-trends-window-toggle]");if(u){const C=Number(u.dataset.rangeStart),I=Number(u.dataset.rangeEnd),_=`${C}-${I}`,A=Oe().rolling.windows.length;G={kind:"all"},qe(),Ht(),rt.has(_)?(rt.delete(_),ae.delete(_)):(Pa(rt,_,A),ae.set(_,{rangeStart:C,rangeEnd:I,label:u.dataset.label||`${C}-${I}`})),x();return}const f=e.target.closest("[data-seat-toggle]");if(f){const C=Number(f.dataset.seatToggle);Wt.includes(C)?Wt=Wt.filter(I=>I!==C):Wt=[...Wt,C].sort((I,_)=>I-_),x();return}const p=e.target.closest("[data-totals-seat-toggle]");if(p){const C=Number(p.dataset.totalsSeatToggle);Tt.includes(C)?Tt=Tt.filter(I=>I!==C):Tt=[...Tt,C].sort((I,_)=>I-_),x();return}if(e.target.closest("[data-seat-view-cycle]")){const C=os.indexOf(At);At=os[(C+1)%os.length],Xt={start:null,end:null,customized:!1},x();return}if(e.target.closest("#add-game-btn")){e.preventDefault(),Z=null,Zt=null,Nt=!0,x();return}if(e.target.closest("#save-game-btn")){e.preventDefault();const C=document.getElementById("add-game-form");if(!C)return;C.querySelectorAll('[name="result"]').forEach(I=>{I.disabled=!1}),Za(new FormData(C));return}if(e.target.closest("#save-deck-btn")){e.preventDefault();const C=document.getElementById("deck-form");C&&Ua(C);return}if(e.target.id==="delete-game-modal"){if(!Z||!confirm("Delete this game?"))return;y.games=y.games.filter(C=>C.id!==Z),Z=null,Nt=!1,ct(y),x(),P("Deleted");return}if(e.target.closest(".game-detail-step")){const C=e.target.closest(".game-detail-step");if(C.disabled||!C.dataset.id)return;Zt=C.dataset.id,x();return}const v=e.target.closest(".view-game");if(v){Zt=v.dataset.id,Nt=!1,Z=null,x();return}if(e.target.id==="add-deck-btn"){kt=null,te=-1,F=null,It(),ne=!0,x();return}if(e.target.id==="delete-deck-modal"){const C=(M=(b=document.getElementById("deck-form"))==null?void 0:b.querySelector('[name="originalId"]'))==null?void 0:M.value,I=String(C||kt||"").trim();if(!I||!confirm("Delete this deck?"))return;const _=et(y.decks,I);_&&rr(y,_),y.decks=y.decks.filter(A=>z(A)!==I),y.games=y.games.filter(A=>A.deck!==I),((F==null?void 0:F.deckSlotId)===I||(F==null?void 0:F.key)===I)&&(F=null,It()),ye(),ct(y),x(),P("Deleted");return}const k=e.target.closest(".edit-deck");if(k){const C=k.dataset.name,I=et(y.decks,C);I&&Xl(I)&&ct(y),te=I?y.decks.indexOf(I):-1,kt=I?z(I):C,F=null,It(),ne=!0,x();return}const R=e.target.closest(".edit-game");if(R){Z=R.dataset.id,Zt=null,Nt=!0,x();return}const h=e.target.closest(".quick-win"),$=e.target.closest(".quick-loss");if(h||$){vd({deck:(h||$).dataset.deck,result:h?"Win":"Loss"});return}e.target.closest(".result-toggle.result-locked")&&(e.preventDefault(),Me())}),document.getElementById("main").addEventListener("change",e=>{var r,o,c,l,i;const{id:n,value:s,checked:a}=e.target;if(n==="deck-status")Je=s,x();else if(n==="deck-bracket")Xe=s,x();else if(n==="deck-sort"){V=s;let d=s,u=Te;s==="recent"?(d="lastPlayed",u="desc"):s==="newest"&&(d="createdAt",u="desc"),S["decks-main"]={col:d,dir:u},Te=u,x()}else if(e.target.name==="deck")aa();else if(e.target.name==="mySeat")ra(),Me();else if(e.target.name==="winnerSeat")Me();else if(e.target.name==="result"){const d=document.getElementById("add-game-form");(Number((r=d==null?void 0:d.querySelector('[name="winnerSeat"]'))==null?void 0:r.value)||0)>0&&Me()}else(n==="filter-deck"||n==="filter-bracket"||n==="filter-result"||n==="filter-year")&&(Bt={deck:((o=document.getElementById("filter-deck"))==null?void 0:o.value)||"",bracket:((c=document.getElementById("filter-bracket"))==null?void 0:c.value)||"",result:((l=document.getElementById("filter-result"))==null?void 0:l.value)||"",year:((i=document.getElementById("filter-year"))==null?void 0:i.value)||""},so())}),document.getElementById("main").addEventListener("submit",e=>{e.target.id==="add-game-form"?(e.preventDefault(),e.target.querySelectorAll('[name="result"]').forEach(n=>{n.disabled=!1}),Za(new FormData(e.target))):e.target.id==="deck-form"&&(e.preventDefault(),Ua(e.target))}),document.getElementById("export-btn").addEventListener("click",vo),(t=document.getElementById("recover-btn"))==null||t.addEventListener("click",()=>{Ul()}),document.getElementById("import-btn").addEventListener("click",()=>{document.getElementById("import-file").click()}),document.getElementById("import-file").addEventListener("change",async e=>{var s;const n=(s=e.target.files)==null?void 0:s[0];if(n){try{y=await wo(n),x(),P("Data imported")}catch{P("Import failed — check the JSON file",!0)}e.target.value=""}}),document.getElementById("reset-btn").addEventListener("click",async()=>{confirm("Delete all games, decks, and recorded players? Export a backup first if you want to keep your data.")&&(y=await ko(),x(),P("Site reset"))})}function Zr(){const t=document.getElementById("nav");t.innerHTML=$l.map(e=>`<button type="button" class="nav-btn ${e.id===Y?"active":""}" data-view="${e.id}">${e.label}</button>`).join("")}function ve(t,e,n){return`<div class="sub-tabs" role="tablist">${t.map(s=>`<button type="button" role="tab" aria-selected="${s.id===e}" class="sub-tab ${s.id===e?"active":""}" data-${n}="${s.id}">${s.label}</button>`).join("")}</div>`}function qe(){Gt={start:null,end:null,customized:!1}}function Ht(){fe={min:1,max:null,customized:!1}}function Bl(t,e){if(!e.length)return[];const n=new Set(e.map(a=>a.id)),s=[];return t.forEach((a,r)=>{n.has(a.id)&&s.push(r+1)}),s}function Nl(t,e){return rt.size&&(e!=null&&e.length)?e.filter(n=>rt.has(`${n.rangeStart}-${n.rangeEnd}`)).flatMap(n=>t.slice(n.rangeStart-1,n.rangeEnd)):Gl(t)}function Qr(t,e){const n=[...t].sort(K),s=n.length;let a=Nl(n,e);const r=_n(a.length?a:n);if(Gt.customized){const p=De(a.length?a:n,Gt);a=Er(a,p)}const o=Bl(n,a),c=o.length?Math.min(...o):1,l=o.length?Math.max(...o):Math.max(1,s),i=Dl(c,l),d=Pl(n,i),u=d.length?d:a.length?a:n,f=De(u,Gt);return{sorted:n,poolGames:a,filterBounds:r,boundsMin:c,boundsMax:l,gameRange:i,rangeGames:d,chartRange:f}}function Dl(t,e){if(t>e)return{min:e,max:e};const n=fe.customized?fe.min??t:t,s=fe.customized?fe.max??e:e;return Us(n,s,t,e)}function Pl(t,e){return[...t].sort(K).slice(e.min-1,e.max)}function Gl(t){const e=[...t].sort(K);return G.kind==="all"?e:G.kind==="window"?e.slice(G.rangeStart-1,G.rangeEnd):G.kind==="cumulative"?e.slice(0,G.rangeEnd):G.kind==="year"?e.filter(n=>mn(n.date)===G.year):e}function is(){return G.kind==="all"?"":G.kind==="window"?`Games ${G.rangeStart}–${G.rangeEnd}`:G.kind==="cumulative"?`Games 1–${G.rangeEnd}`:G.kind==="year"?G.year:""}function zl(t){return G.kind==="cumulative"&&G.rangeEnd===t.games}function Ol(t){return G.kind==="year"&&G.year===t.year}let to=[];function Fl(t){const e=Ms(t,At);if(!Xt.customized)return{start:e.min,end:e.max,bounds:e};const n=Xt.start||e.min,s=Xt.end||e.max;return{start:n<e.min?e.min:n,end:s>e.max?e.max:s,bounds:e}}function jl(t,e,n){t&&e.forEach(s=>{const a=n(s);if(!a)return;const r=o=>{t.hidden=!1,t.innerHTML=a,t.style.left=`${o.clientX+12}px`,t.style.top=`${o.clientY+12}px`};s.addEventListener("mouseenter",r),s.addEventListener("mousemove",r),s.addEventListener("mouseleave",()=>{t.hidden=!0})})}function Hl(t){return t!=null&&t.length?t.map(e=>`${D(e.player)}: ${e.games}`).join("<br>"):""}function ql(){const t=document.getElementById("matchup-deck-tip");t&&jl(t,document.querySelectorAll(".matchup-pop-trigger"),e=>{const n=to[Number(e.dataset.matchupRowIndex)];return Hl(n==null?void 0:n.opponentPlayerBreakdown)})}function _l(t){return t==="active"?"Active":t==="retired"?"Retired":"All Decks"}function eo(t,e){return e==="active"?t.filter(n=>!n.retired):e==="retired"?t.filter(n=>n.retired):t}function no(t,e,n){if(n==="all")return t;const s=it(e);return t.filter(a=>{var o;const r=((o=s.get(a.deck))==null?void 0:o.retired)??!1;return n==="retired"?r:!r})}function Oe(){const t=In(y.decks,y.games),e=eo(y.decks,dt),n=jn(no(y.games,y.decks,dt),y.decks,J),s=In(dt==="all"?y.decks:e,n).map(r=>({...r,colors:pn(r)})),a=ur(n);return{deckStats:t,overview:a,colorStats:Qo(s,{view:Ge,agg:ze,sortOrder:un,bracketFilter:J}),bracketStats:Lo(n,s),yearStats:Eo(n),rolling:Wo(n),matchups:Ac(n,{splitPartners:rn,splitPlayers:Jt,combineDecks:Ut,colorOptions:{decks:y.decks,deckFilter:dt,bracketFilter:J,view:sn,agg:an}}),totals:Vi(y.games,y.decks,{splitPartners:gn,excludeMyPlayer:de,view:on,agg:cn,bracketFilter:Pe})}}function Kl(t){if(!F)return;const e=t.target.closest("th[data-sort-col]");if(!e)return;const n=e.getAttribute("data-sort-table"),s=e.getAttribute("data-sort-col");if(!(!n||!s)){if(n==="entity-games")ln=Sn(ln,s);else if(n==="entity-matchups-players")ue.players=Sn(ue.players,s);else if(n==="entity-matchups-decks")ue.decks=Sn(ue.decks,s);else return;It()}}function Ae(){var t;(t=document.getElementById("recovery-modal"))==null||t.remove()}async function Ul(){Ae(),oe=await Hr(),Es()}function Es(){Ae();const t=document.createElement("div");t.innerHTML=qi(oe,{currentGames:y.games.length,currentDecks:y.decks.length,origin:window.location.origin+window.location.pathname});const e=t.firstElementChild;e&&(document.body.appendChild(e),Vl(e))}function Vl(t){var e,n,s;(e=t.querySelector("#recovery-close-btn"))==null||e.addEventListener("click",Ae),(n=t.querySelector("#recovery-rescan-btn"))==null||n.addEventListener("click",async()=>{oe=await Hr(),Es(),P("Scan complete")}),(s=t.querySelector("#recovery-file-input"))==null||s.addEventListener("change",async a=>{const r=[...a.target.files||[]];r.length&&(oe=[...oe,...await Hi(r)],Es(),a.target.value="")}),t.querySelectorAll("[data-recovery-merge]").forEach(a=>{a.addEventListener("click",()=>{const r=Wa(oe,a.getAttribute("data-recovery-merge"));if(!(r!=null&&r.data))return;const{merged:o,missingGames:c,missingDecks:l}=Oi(y,r.data);if(!c.length&&!l.length){P("Nothing new to merge from that snapshot");return}if(!ct(o)){P("Recovery merge failed — storage may be full",!0);return}y=o,Ae(),x(),P(`Recovered ${c.length} games and ${l.length} decks`)})}),t.querySelectorAll("[data-recovery-replace]").forEach(a=>{a.addEventListener("click",()=>{var o,c;const r=Wa(oe,a.getAttribute("data-recovery-replace"));if(r!=null&&r.data&&confirm(`Replace all current data with this snapshot (${((o=r.stats)==null?void 0:o.games)||0} games, ${((c=r.stats)==null?void 0:c.decks)||0} decks)? Export a backup first if you are unsure.`)){if(!ct(r.data)){P("Recovery replace failed — storage may be full",!0);return}y=r.data,Ae(),x(),P("Data restored from snapshot")}})})}function It(){let t=document.getElementById("entity-report-modal");if(!F||ne){t==null||t.remove();return}const e=ci(y.games,y.decks,{kind:F.kind,key:F.key,playerScope:F.playerScope,deckSlotId:F.deckSlotId,splitPartners:gn}),n=Or(e.chartGames,We,dn);t||(t=document.createElement("div"),t.id="entity-report-modal",t.className="modal",t.addEventListener("click",Kl),document.body.appendChild(t)),t.classList.remove("hidden");const s=t.querySelector(".modal-content-report"),a=(s==null?void 0:s.scrollTop)??0;t.innerHTML=vi(e,y.decks,Un,ue,ln,{heroTab:Vn,chartContext:n});const r=t.querySelector(".modal-content-report");r&&a>0&&(r.scrollTop=a),Pr(),Nr(n.boundsMin,n.boundsMax,({min:o,max:c})=>{dn={min:o,max:c,customized:!0},It()},"entity-report"),wi(t),fc(e.title)}function Yl(){return te>=0&&y.decks[te]?y.decks[te]:kt?y.decks.find(t=>z(t)===kt)||et(y.decks,kt):null}function Jl(t){if(!t)return-1;const e=y.decks.findIndex(s=>z(s)===t);if(e>=0)return e;const n=et(y.decks,t);return n?y.decks.indexOf(n):-1}function Xl(t){return t.id?!1:(t.id=ls(y),!0)}function Zl(t){return{commander:O(t),name:String(t.name||""),bracket:t.bracket??4,colors:[...t.colors||[]],changedAt:ee()}}function Ql(t,e){const n=H(O(t)).canonicalName,s=H(e.commander).canonicalName;return n!==s}function td(t,e,n=-1){const s=H(e).canonicalName;return t.filter((a,r)=>r!==n&&H(O(a)).canonicalName===s)}function Ka(t,e,n,s=-1){const a=td(t,e,s);if(!a.length)return null;const r=String(n||"").trim();if(!r)return"Give this deck a name — another deck already uses this commander";const o=r.toLowerCase();return a.some(c=>String(c.name||"").trim().toLowerCase()===o)?"Another deck with this commander already uses that name":null}function ed(t){const e=z(t);if(!e)return!1;let n=!1;for(const s of y.games){if(s.deck!==e)continue;const a=As(t,s.date);a&&s.myCommander!==a&&(s.myCommander=a,n=!0)}return n}function ye(){ne=!1,kt=null,te=-1}function Ua(t=null){const e=t||document.getElementById("deck-form");if(!e){P("Could not save deck — form missing",!0);return}const n=new FormData(e),s=String(n.get("commander")||"").trim();if(!s){P("Commander is required",!0);return}let a=n.getAll("color");a.length||(a=qn(s));const r={name:String(n.get("name")||"").trim(),commander:s,bracket:Number(n.get("bracket"))||4,colors:a,archetypes:Ri(n.get("archetypes")),retired:n.get("retired")==="on",createdAt:T(String(n.get("createdAt")||""))||ee()},o=String(n.get("originalId")||"").trim(),c=te>=0?te:o?y.decks.findIndex(i=>z(i)===o):kt?Jl(kt):-1;if(c>=0){const i=y.decks[c];if(!i){P("Deck not found",!0);return}const d=z(i)||o||ls(y),u=Ka(y.decks,s,r.name,c);if(u){P(u,!0);return}const f=[...i.history||[]],p=Ql(i,r);if(p&&(f.push(Zl(i)),sr(y,d,O(i))),y.decks[c]={...i,...r,id:d,history:f,createdAt:r.createdAt||i.createdAt||ee()},p&&ed(y.decks[c]),!ct(y)){P("Failed to save deck — storage may be full",!0);return}ye(),P("Deck saved"),x(),Gn();return}const l=Ka(y.decks,s,r.name);if(l){P(l,!0);return}if(y.decks.push({...r,id:ls(y),history:[]}),!ct(y)){y.decks.pop(),P("Failed to add deck — storage may be full",!0);return}ye(),P(`Added ${B(r)}`),x(),Gn()}function x(){var r,o;const t=((r=document.activeElement)==null?void 0:r.id)==="matchup-search",e=t?document.activeElement.selectionStart:null,n=((o=document.activeElement)==null?void 0:o.id)==="totals-search",s=n?document.activeElement.selectionStart:null,a=document.getElementById("main");if(Y==="stats"?a.innerHTML=rd():Y==="decks"?a.innerHTML=od():a.innerHTML=cd(),Y==="games"&&so(),Uo(),Y==="stats"&&(E==="trends"||E==="seats"||E==="colors"||E==="brackets"||E==="totals"&&U==="seats")&&(Pr(),E==="trends")){const{statsGames:c}=_t(),{boundsMin:l,boundsMax:i}=Qr(c,Oe().rolling.windows);Nr(l,i,({min:d,max:u})=>{fe={min:d,max:u,customized:!0},x()})}if(Y==="stats"&&(E==="turns"||E==="totals"&&U==="turns")&&rl(),Y==="stats"&&E==="matchups"&&Yt==="decks"&&ql(),Nt){ra(),Me(),aa();const c=Z?y.decks:y.decks.filter(l=>!l.retired);ic(document.getElementById("add-game-form"),y.games,c)}if(It(),t){const c=document.getElementById("matchup-search");c&&(c.focus(),e!=null&&c.setSelectionRange(e,e))}if(n){const c=document.getElementById("totals-search");c&&(c.focus(),s!=null&&c.setSelectionRange(s,s))}if(Y==="decks"&&ne){Ei(document.getElementById("deck-form"),y.decks);const c=document.querySelector('#deck-form input[name="name"]');c==null||c.focus(),kt&&(c==null||c.select())}}function so(){const{deck:t,bracket:e,result:n,year:s}=Bt,a=document.getElementById("filter-count");if(!a)return;let r=0;document.querySelectorAll("#game-log-table tbody tr").forEach(o=>{const c=(!t||o.dataset.deck===t)&&(!e||o.dataset.bracket===e)&&(!n||o.dataset.result===n)&&(!s||o.dataset.year===s);o.hidden=!c,c&&r++}),a.textContent=`${r} games`}function Re(t,e,n=!1){const s=n?N(e):`<span class="stat-value">${e}</span>`;return`<div class="stat-card"><span class="stat-label">${t}</span>${s}</div>`}function vn(t,e=""){const n=Lr(t),s=e?` title="${D(e)}"`:"";return`<span class="impact-cell ${n}"${s}>${Ir(t)}</span>`}function nd(t,e=Ts){if(!t.length)return"";const n=["1st","2nd","3rd"];return`<div class="podium">${t.map((s,a)=>`
      ...
      <div class="chart-table-row">
        <div class="chart-table-grow">
          <table class="table compact sortable-table">
            ...
            <tbody>
              ${c.map((m,v)=>{const k=yt.has(m.key)?ms(la(m),v):null;return`
                <tr class="chart-series-selectable${k?" active":""}" data-color-chart-row="${m.key}"${cs(k)}>
                  <td><span class="color-label">${Kt(m.displayColors)}</span></td>
                  <td>${m.key==="C"?m.decks:Lt(m.decks,u)}</td>
                  <td>${m.key==="C"?m.games:Lt(m.games,i)}</td>
                  <td>${m.key==="C"?m.wins:Lt(m.wins,d)}</td>
                  <td>${m.games?N(m.winRate):"—"}</td>
                </tr>`}).join("")}
            </tbody>
          </table>
        </div>
      ...
      ${ke(f,"clear-brackets-chart")}`}else if(E==="trends"){const{statsGames:a}=_t(),r=t.rolling.windows.length?st(t.rolling.windows,S["trends-windows"],{label:h=>h.label,rangeStart:h=>h.rangeStart,games:h=>h.games,winRate:h=>h.winRate}):[],{filterBounds:o,boundsMin:c,boundsMax:l,gameRange:i,rangeGames:d,chartRange:u}=Qr(a,r),f=d.filter(h=>h.result==="Win").length,p=d.length?W(f,d.length):null,g=Fc({title:is(),winRate:p,gameCount:d.length,min:i.min,max:i.max,boundsMin:c,boundsMax:l}),m=Er(a,u);let v="current";if(G.kind!=="all")v="hidden";else{const h=_n(a).max;Gt.customized&&u.end<h&&(v="at-end")}const k=Uc(_c(m),{streakMode:v});let R="";if(rt.size&&r.length){const h=new Set(d.map($=>$.id));R=je(r.filter($=>rt.has(`${$.rangeStart}-${$.rangeEnd}`)).map($=>{const b=`${$.rangeStart}-${$.rangeEnd}`,M=Nc(a,$.rangeStart,$.rangeEnd).filter(C=>h.has(C.id));return{id:b,label:$.label,color:bn(rt,b,r.length),series:qt(M)}}),u,is(),g)}else R=Dr(qt(d),is(),u,g);if(!t.rolling.windows.length)e=`${kn("trends",o,u,{bracketFilter:!0,deckFilter:!0})}${k}${ke(R,"clear-trends-chart")}`;else{const h=r,$=st(t.rolling.cumulative,S["trends-cumulative"],{label:b=>b.label,games:b=>b.games,winRate:b=>b.winRate});e=`
        ${kn("trends",o,u,{bracketFilter:!0,deckFilter:!0})}
        ${k}
        <h3 class="section-sub">By Year</h3>
        <div class="year-row">
          <button type="button" class="year-chip trends-selectable ${G.kind==="all"?"active":""}" data-trends-all>
            <strong>All Time</strong>
            <span>${t.overview.games}g · ${t.overview.wins}w · ${N(t.overview.winRate)}</span>
          </button>
          ${t.yearStats.map(b=>`
            <button type="button" class="year-chip trends-selectable ${Ol(b)?"active":""}"
              data-trends-year="${b.year}">
              <strong>${b.year}</strong>
              <span>${b.games}g · ${b.wins}w · ${N(b.winRate)}</span>
            </button>`).join("")}
        </div>
        ...
        <div class="two-col">
          <div>
            ...
            <table class="table compact sortable-table trends-table">
              ...
              <tbody>
                ${h.map(b=>{const M=`${b.rangeStart}-${b.rangeEnd}`,C=bn(rt,M,h.length);return`
                  <tr class="chart-series-selectable trends-selectable${C?" active":""}"
                    data-trends-window-toggle data-label="${D(b.label)}"
                    data-range-start="${b.rangeStart}" data-range-end="${b.rangeEnd}"${cs(C)}>
                    <td>${b.label}</td>
                    <td>${N(b.winRate)}</td>
                  </tr>`}).join("")}
              </tbody>
          ...
          <div>
            ...
            <table class="table compact sortable-table trends-table">
              ...
              <tbody>
                ${$.map(b=>`
                  <tr class="trends-selectable ${zl(b)?"active":""}"
                    data-trends-cumulative data-range-end="${b.games}">
                    <td>${b.label}</td>
                    <td>${N(b.winRate)}</td>
                  </tr>`).join("")}
              </tbody>
        ...
        <tbody>
          ${r.length?r.map(i=>`
            <tr>
              ...
              <td>${Lt(i.games,o)}</td>
              <td>${Lt(i.wins,c)}</td>
              <td>${i.games?N(i.winRate):"—"}</td>
              <td>${i.games?N(i.normalizedWr):"—"}</td>
      ...
      <div class="seat-toggle-row">
        ...
        ${c.map(i=>`
          <button type="button" class="seat-toggle ${Wt.includes(i.seat)?"active":""}"
            ...
            <span>${i.games}G · ${i.wins}W · ${i.games?N(i.winRate):"—"}</span>
          </button>`).join("")}
      </div>
      ${ke(l,"clear-seats-chart")}`}else if(E==="matchups"){const a=Yt==="decks",r=Yt==="colors",o=Dn.trim().toLowerCase(),i=st(t.matchups[Yt]||[],S.matchups,{subject:m=>m.subject,opponent:m=>m.opponent,games:m=>m.games,wins:m=>m.wins,opponentCount:m=>m.opponentCount??0,winRate:m=>m.winRate,matchupImpact:m=>m.matchupImpact,normalizedMatchupImpact:m=>m.normalizedMatchupImpact,opponentMatchupImpact:m=>m.opponentMatchupImpact,opponentNormalizedMatchupImpact:m=>m.opponentNormalizedMatchupImpact,outcomeTieRank:m=>m.sharedLosses-m.losses},{...wt,matchupImpact:["outcomeTieRank","games"],normalizedMatchupImpact:["outcomeTieRank","games"],opponentMatchupImpact:"games",opponentNormalizedMatchupImpact:"games"}).map((m,v)=>({...m,rank:v+1})).filter(m=>o?a?Ut?m.opponent.toLowerCase().includes(o)||m.opponentPlayer&&m.opponentPlayer.toLowerCase().includes(o):m.opponent.toLowerCase().includes(o)||m.subject.toLowerCase().includes(o)||m.opponentPlayer&&m.opponentPlayer.toLowerCase().includes(o):r?Jo(m,o):m.opponent.toLowerCase().includes(o):!0);to=a?i:[];const d=a?Ut?"Search opponent decks":"Search my or opponent decks":r?'Search Color: "WUB"':"Search opponents",u=r?`<button type="button" class="btn btn-ghost btn-sm" id="matchup-color-view-toggle">${Qn(sn)}</button>
      ...
      <div class="filters inline matchup-filters">
        ...
        ${u}
        ${f}
        <input type="search" id="matchup-search" class="input matchup-search" placeholder="${d}" value="${D(Dn)}" />
      </div>
        ...
        <tbody>
          ${i.map((m,v)=>`
            <tr>
              ...
              <td>${m.games}</td>
              <td>${m.wins}</td>
              ${a&&!Jt?`<td class="matchup-pop-col">${m.opponentCount?`<span class="matchup-pop-trigger has-tip" data-matchup-row-index="${v}">${m.opponentCount}</span>`:"—"}</td>`:""}
              <td>${N(m.winRate)}</td>
      ...
      ${a&&!Jt?'<div id="matchup-deck-tip" class="deck-opponent-tip" hidden></div>':""}`}else if(E==="totals"){const a=U==="decks",r=U==="players",o=U==="colors",c=U==="archetypes",l=U==="seats",i=U==="turns",d=Il(),u=Se("totals-bracket-filter-toggle",Pe),f=`<label class="checkbox totals-exclude-me">
      <input type="checkbox" id="totals-exclude-me" ${de?"checked":""} />
      Exclude my data
    </label>`;if(c){const p=de?[]:st(Aa(d,y.decks,{view:me}),S["archetype-stats"],{label:k=>k.label,decks:k=>k.decks,games:k=>k.games,wins:k=>k.wins,winRate:k=>k.winRate,normalizedWr:k=>k.normalizedWr},wt),g=Et(p,"games"),m=Et(p,"wins"),v=Et(p,"decks");e=`
      ${ve(hn,U,"totals-tab")}
        ...
        <tbody>
          ${p.length?p.map(k=>`
            <tr>
              ...
              <td>${Lt(k.games,g)}</td>
              <td>${Lt(k.wins,m)}</td>
              <td>${k.games?N(k.winRate):"—"}</td>
              <td>${k.games?N(k.normalizedWr):"—"}</td>
      ...
      <div class="seat-toggle-row seat-toggle-row--four">
        ${v.map(R=>`
          <button type="button" class="seat-toggle ${Tt.includes(R.seat)?"active":""}"
            ...
            <span>${R.games}G · ${R.wins}W · ${R.games?N(R.winRate):"—"}</span>
          </button>`).join("")}
      </div>
      ${ke(k,"clear-totals-seats-chart")}`}else if(i){const p=tl(d,{decks:y.decks}),g=st(p,S["turn-stats"],{turn:v=>v.turn,games:v=>v.games,winRate:v=>v.winRate??-1,normalizedWr:v=>v.normalizedWr??-1},wt),m=Na(p,{gradientId:"totals-turn-wr-fill-gradient",mode:"distribution"});e=`
      ${ve(hn,U,"totals-tab")}
      ...
      ${p.length?`${El(g)}
          ${m}`:'<p class="muted">No turn data yet — add an end turn when logging games.</p>'}`}else{const p=Pn.trim().toLowerCase(),g=`totals-${U}`,m=st(t.totals[U]||[],S[g],{name:b=>b.name,colors:b=>us(b.colors||[]),pilotCount:b=>b.pilotCount??0,commanderCount:b=>b.commanderCount??0,playerCount:b=>b.playerCount??0,games:b=>b.games,wins:b=>b.wins,winRate:b=>b.winRate,normalizedWr:b=>b.normalizedWr,bracket:b=>b.bracket??null},wt).map((b,M)=>({...b,rank:M+1})).filter(b=>!p||b.name.toLowerCase().includes(p)),v=a?"Deck":r?"Player":"Colors",k=a||o?`<label class="checkbox totals-split-partners">
          <input type="checkbox" id="totals-split-partners" ${gn?"checked":""} />
          Split partners
        </label>`:"",R=`<input type="search" id="totals-search" class="input totals-search" placeholder="Search ${v.toLowerCase()}" value="${D(Pn)}" />`,h=o?`<div class="filters inline totals-filters totals-color-toolbar">
        ${u}
        ...
        ${f}
        ${R}
      </div>`,$=a?w(g,"pilotCount","Pilots",S[g]):r?w(g,"commanderCount","Decks",S[g]):`${w(g,"playerCount","Pilots",S[g])}${w(g,"commanderCount","Decks",S[g])}`;e=`
      ${ve(hn,U,"totals-tab")}
      ${h}
    ...
    <section class="section">
      ...
      <div class="table-wrap">
        <table class="table sortable-table decks-table">
          ...
          <tbody>
            ${e.length?e.map(i=>`<tr><td class="deck-date">${o(i)}</td><td class="deck-name">${vt(O(i),y.decks,{label:B(i),deckSlotId:z(i)})}</td><td class="deck-colors">${Kt(pn(i))}</td><td class="deck-tight">${i.bracket}</td><td class="deck-tight">${i.games}</td><td class="deck-tight">${i.wins}</td><td class="deck-stat">${i.games?N(i.winRate):"—"}</td><td class="deck-stat">${i.games?N(i.normalizedWr):"—"}</td><td class="row-actions"><button type="button" class="btn-icon edit-deck" data-name="${D(z(i)||Fe(i))}" title="Edit deck">✎</button></td></tr>`).join(""):'<tr><td colspan="9"></td></tr>'}
          </tbody>
        </table>
      </div>
    </section>
    <div id="deck-modal" class="modal${ne?"":" hidden"}">
      <div class="modal-content modal-content-deck">
        ...
        <form id="deck-form" class="deck-form" novalidate>
          ${c?`<input type="hidden" name="originalId" value="${D(z(c))}" />`:""}
          <label>Name<input name="name" placeholder="Optional deck name" value="${c?D(c.name||""):""}" /></label>
          <label>Commander<input name="commander" value="${c?D(Ts(c)):""}" /></label>
          ...
          <label>Archetypes
            <div class="deck-archetype-wrap opponent-input-wrap">
              <textarea name="archetypes" class="deck-archetype-input opponent-input" rows="1" placeholder="Turbo, Storm, …" autocomplete="off">${c?D(xi(c.archetypes)):""}</textarea>
    ...
    <section class="section">
      <div class="section-header">
        <div class="filters inline game-log-filters">
          <label class="game-log-filter-deck">Deck<select id="filter-deck" class="game-log-filter-deck-select"><option value="">All</option>${e.map(o=>`<option value="${D(o)}" ${Bt.deck===o?"selected":""}>${D(On(o,y.decks))}</option>`).join("")}</select></label>
    ...
    </div>`}function Ya(t=""){return[1,2,3,4].map(e=>`<option value="${e}" ${String(t)===String(e)?"selected":""}>${e}</option>`).join("")}function ao(t,e){if(!(t!=null&&t.opponents))return"";const n=t.opponents.find(s=>s.seat===e);return(n==null?void 0:n.name)||""}function ro(t,e){var s;if(!t)return"";if(t.mySeat===e&&t.myPlayer)return t.myPlayer;const n=(s=t.opponents)==null?void 0:s.find(a=>a.seat===e);return(n==null?void 0:n.player)||""}function Ve(t,e="—"){const n=t!=null&&t!==""?String(t):e;return`<span class="field-value">${D(n)}</span>`}function Ja(t,e="player",n=null,s=null){if(t==null||t==="")return Ve("—");if(e==="player")return`<span class="field-value">${ge(t)}</span>`;const a=n&&s?oo(n,s):null;return`<span class="field-value">${vt(t,y.decks,{label:t,playerScope:a})}</span>`}function oo(t,e){return Number(t.mySeat)===e?lt:ro(t,e)}function id(t,e){return Number(t.mySeat)===e?zn(t,y.decks):ao(t,e)}function ld(t){return t.winnerSeat?Number(t.winnerSeat):t.mySeat&&t.result==="Win"?Number(t.mySeat):0}function dd(t,e){const n=ld(t);return n?e===n?"pod-seat-win":"pod-seat-loss":Number(t.mySeat)===e&&t.result==="Loss"?"pod-seat-loss":""}function ud(){let t=[...y.games];t=st(t,S["game-log"],{date:o=>zt(o),deck:o=>o.deck,bracket:o=>mt(o,it(y.decks)),mySeat:o=>o.mySeat||0,turn:o=>Number(o.turn)>0?Number(o.turn):null,result:o=>o.result==="Win"?1:0});const{deck:e,bracket:n,result:s,year:a}=Bt,r=it(y.decks);return t.filter(o=>!(e&&o.deck!==e||n&&String(mt(o,r))!==String(n)||s&&o.result!==s||a&&mn(o.date)!==a))}function md(t){const e=ud(),n=e.findIndex(s=>s.id===t);return{prev:n>0?e[n-1].id:null,next:n>=0&&n<e.length-1?e[n+1].id:null,index:n,total:e.length}}function fd(t){const{prev:e,next:n,index:s,total:a}=md(t),r=s>=0?`${s+1} / ${a}`:"";return`
    <div class="game-detail-nav">
      <button type="button" class="btn btn-ghost game-detail-step" id="game-detail-prev" ${e?`data-id="${D(e)}"`:"disabled"} aria-label="Previous game">←</button>
      <span class="game-detail-position">${r}</span>
      <button type="button" class="btn btn-ghost game-detail-step" id="game-detail-next" ${n?`data-id="${D(n)}"`:"disabled"} aria-label="Next game">→</button>
    ...
    <form id="add-game-form" class="game-form">
      ${e?`<input type="hidden" name="gameId" value="${D(e.id)}" />`:""}
      <div class="game-form-row game-form-row-split">
        <label>Date<input type="date" name="date" value="${o}" required /></label>
        <label>Time<input type="time" name="time" value="${D(c)}" /></label>
      </div>
      <div class="game-form-row game-form-row-split">
      ...
      <label>My deck<select name="deck" required><option value="">Select…</option>${s.map(u=>`<option value="${D(z(u))}" data-bracket="${u.bracket}" ${(e==null?void 0:e.deck)===z(u)?"selected":""}>${D(B(u))}</option>`).join("")}</select></label>
          ...
          <div class="pod-seat-row" data-opponent-seat="${u}">
            <label class="pod-player">Player ${u}
              <div class="opponent-input-wrap">
                <input type="text" class="player-input" name="player-${u}" value="${D(ro(e,u))}" placeholder="Player name" autocomplete="off" />
                <ul class="opponent-suggestions" hidden role="listbox"></ul>
              </div>
            </label>
            <label class="pod-commander">Commander
              <div class="opponent-input-wrap">
                <input type="text" class="opponent-input" name="opponent-${u}" value="${D(ao(e,u))}" placeholder="Commander name" autocomplete="off" />
                <ul class="opponent-suggestions" hidden role="listbox"></ul>
              </div>
            </label>
          </div>`).join("")}
      ...
      <div class="quick-grid">
        ${a.map(u=>`
          <div class="quick-deck">
            <span class="quick-name">${Kt(pn(u))} ${D(B(u))}</span>
            <button type="button" class="btn btn-sm win quick-win" data-deck="${D(z(u))}">W</button>
            <button type="button" class="btn btn-sm loss quick-loss" data-deck="${D(z(u))}">L</button>
          </div>`).join("")}
      </div>
    </div>`}function bd(t){const e=t.result==="Win"?"win":"loss",n=et(y.decks,t.deck),s=n?B(n):On(t.deck,y.decks),a=vt(n?O(n):zn(t,y.decks),y.decks,{label:s,playerScope:lt,deckSlotId:t.deck}),r=mt(t,new Map(y.decks.map(o=>[z(o),o])));return`<tr data-deck="${D(t.deck)}" data-bracket="${r}" data-result="${t.result}" data-year="${mn(t.date)}">
